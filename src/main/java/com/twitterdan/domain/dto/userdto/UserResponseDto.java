...
public class UserResponseDto {
  ...
  public String toString() {
    return "UserResponseDto{" + "id=" + id + ", name='"
            + name + '\'' + ", userTag='" + userTag + '\''
            + ", email='" + email + '\'' + ", password='"
            + password + '\'' + ", birthDate=" + birthDate + ", bio='" + bio + '\''
            + ", location='" + location + '\'' + ", avatarImgUrl='" + avatarImgUrl + '\''
            + ", headerImgUrl='" + headerImgUrl + '\'' + ", followersIds=" + followersIds
            + ", followingsIds=" + followingsIds + ", tweetsIds=" + tweetsIds + '}';
  }
}

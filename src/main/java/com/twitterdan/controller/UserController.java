...
public class UserController {
	...
	public void updateUserProfile(@Valid @RequestBody CustomStyleRequest dto) {
		userService.updateCustomStyle(dto.getUserId(), customStyleRequestMapper.convertToEntity(dto));
	}

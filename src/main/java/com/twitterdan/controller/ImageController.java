...
import com.twitterdan.dto.cloudinary.CloudinaryImageRequest;
...
public class ImageController {
  ...
  public ResponseEntity<CloudinaryImageResponse> saveImage(@RequestBody CloudinaryImageRequest cloudinaryImageRequest) throws IOException {
    MultipartFile uploadFile = cloudinaryImageRequest.getUploadFile();
    String url = cloudinaryService.uploadImage(uploadFile);

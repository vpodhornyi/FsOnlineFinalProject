...
import {EmojiIcon, GifIcon, ImageIcon, PollIcon, ScheduleIcon} from "../../media/icons";
import {
  AvatarContainer,
  Form,
  FormFooter,
...
export const TweetForm = (props) => {
  ...
  return (
      <TwitterContainer>
        ...
        <Form>
          <TweetInput>
            <Input onFocus={onInputFocus} type={'text'} disableUnderline={true}
                   fullWidth={true}
                   placeholder={`What's happening?`} value={tweetText}
                   onChange={onInputChange}/>
            {showReplyText && (
                <ReplyText><PublicIcon fontSize={'small'} style={{paddingRight: 10}}/> Everyone can reply
                </ReplyText>)}
          </TweetInput>
          <FormFooter>
            <IconsList>
              ...
              <Icon>
                ...
                {isEmojiVisible && <EmojiPicker onEmojiClick={onEmojiClick} autoFocusSearch={false}/>}
              </Icon>
              <Icon>
                <ScheduleIcon/>
              </Icon>

...
const CustomizationModal = () => {
  const {
    ...
    customize: { fontSize, color, backgroundColor },
  ...
  return fontSize ? (
    <BoxWrapper>
      ...
      <StickyHeader className="DisplayHeader">
        <Box className="backButton" sx={{ mr: "10px" }} onClick={close}>
          <CustomIconButton
        ...
        <Typography className="DisplayHeaderTitle" variant="h2">
          Customize your view
        </Typography>
      </StickyHeader>
      <Box className="DisplayBody">
        ...
        <StyledBox>
          <ColorCustomization handleChange={colorHandler} activeValue={color} />
        </StyledBox>
